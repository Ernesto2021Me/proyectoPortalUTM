...
@Component({
  selector: 'app-doctorado-en-robotica',
  templateUrl: './doctorado-en-robotica.component.html',
  styleUrls: ['./doctorado-en-robotica.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class DoctoradoEnRoboticaComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('61').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('61').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('61').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('61').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('61').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('61').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('61').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('61').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('61').subscribe(
