...
@Component({
  selector: 'app-maestria-en-ingenieria-de-software',
  templateUrl: './maestria-en-ingenieria-de-software.component.html',
  styleUrls: ['./maestria-en-ingenieria-de-software.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class MaestriaEnIngenieriaDeSoftwareComponent implements OnInit {
...
private loadInformacion_carreras_posgrado(): void {
  this.carrerasService.informacion_carrera_posgrado('68').subscribe(
...
private loadNucleo_academico(){
  this.carrerasService.nucleo_academico('68').subscribe(
...
private loadlineas_de_generacion(){
  this.carrerasService.linea_de_generacion('68').subscribe(
...
private loadtutoria_seguimiento(){
  this.carrerasService.tutoria_seguimiento('68').subscribe(
...
private loadalumnos_matriculados(){
  this.carrerasService.alumnos_matriculados('68').subscribe(
...
private loadvinculacion_sector(){
  this.carrerasService.vinculacion_sector('68').subscribe(
...
private loadproductividad_publicaciones(){
  this.carrerasService.productividad_publicaciones('68').subscribe(
...
private loadproductividad_eventos(){
  this.carrerasService.productividad_eventos('68').subscribe(
...
private loadproductividad_proyectos(){
  this.carrerasService.productividad_proyectos('68').subscribe(
