...
@Component({
  selector: 'app-doctorado-en-tecnologias-de-computo-aplicado',
  templateUrl: './doctorado-en-tecnologias-de-computo-aplicado.component.html',
  styleUrls: ['./doctorado-en-tecnologias-de-computo-aplicado.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class DoctoradoEnTecnologiasDeComputoAplicadoComponent implements OnInit {
