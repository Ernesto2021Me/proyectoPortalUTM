...
@Component({
  selector: 'app-maestria-en-inteligencia-artificial',
  templateUrl: './maestria-en-inteligencia-artificial.component.html',
  styleUrls: ['./maestria-en-inteligencia-artificial.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class MaestriaEnInteligenciaArtificialComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('65').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('65').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('65').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('65').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('65').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('65').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('65').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('65').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('65').subscribe(
