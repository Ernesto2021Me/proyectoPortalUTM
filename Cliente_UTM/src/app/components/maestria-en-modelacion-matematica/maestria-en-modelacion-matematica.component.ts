...
@Component({
  selector: 'app-maestria-en-modelacion-matematica',
  templateUrl: './maestria-en-modelacion-matematica.component.html',
  styleUrls: ['./maestria-en-modelacion-matematica.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class MaestriaEnModelacionMatematicaComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('54').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('54').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('54').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('54').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('54').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('54').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('54').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('54').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('54').subscribe(
