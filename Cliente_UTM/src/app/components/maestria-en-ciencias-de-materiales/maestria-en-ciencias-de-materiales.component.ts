...
export class MaestriaEnCienciasDeMaterialesComponent implements OnInit {
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('53').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('53').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('53').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('53').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('53').subscribe(
