...
export class MaestriaEnCienciasProductosNaturalesYAlimentacionComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('59').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('59').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('59').subscribe(
