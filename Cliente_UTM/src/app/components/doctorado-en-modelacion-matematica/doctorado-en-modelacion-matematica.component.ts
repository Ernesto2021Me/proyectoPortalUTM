...
@Component({
  selector: 'app-doctorado-en-modelacion-matematica',
  templateUrl: './doctorado-en-modelacion-matematica.component.html',
  styleUrls: ['./doctorado-en-modelacion-matematica.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class DoctoradoEnModelacionMatematicaComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('63').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('63').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('63').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('63').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('63').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('63').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('63').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('63').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('63').subscribe(
