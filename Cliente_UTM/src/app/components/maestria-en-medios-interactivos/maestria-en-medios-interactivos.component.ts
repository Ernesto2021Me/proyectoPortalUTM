...
export class MaestriaEnMediosInteractivosComponent implements OnInit {
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('52').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('52').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('52').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('52').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('52').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('52').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('52').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('52').subscribe(
