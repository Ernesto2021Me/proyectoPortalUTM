...
@Component({
  selector: 'app-maestria-en-tecnologia-avanzada-de-manufactura',
  templateUrl: './maestria-en-tecnologia-avanzada-de-manufactura.component.html',
  styleUrls: ['./maestria-en-tecnologia-avanzada-de-manufactura.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class MaestriaEnTecnologiaAvanzadaDeManufacturaComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('57').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('57').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('57').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('57').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('57').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('57').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('57').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('57').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('57').subscribe(
