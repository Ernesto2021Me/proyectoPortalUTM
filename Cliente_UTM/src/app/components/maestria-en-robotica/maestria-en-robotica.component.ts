...
@Component({
  selector: 'app-maestria-en-robotica',
  templateUrl: './maestria-en-robotica.component.html',
  styleUrls: ['./maestria-en-robotica.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class MaestriaEnRoboticaComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('55').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('55').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('55').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('55').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('55').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('55').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('55').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('55').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('55').subscribe(
