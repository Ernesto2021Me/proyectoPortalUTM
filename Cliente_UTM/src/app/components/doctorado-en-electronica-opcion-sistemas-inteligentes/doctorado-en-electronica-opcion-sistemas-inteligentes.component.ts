...
export class DoctoradoEnElectronicaOpcionSistemasInteligentesComponent implements OnInit {
  ...
  private loadInformacion_carreras_posgrado(): void {
    this.carrerasService.informacion_carrera_posgrado('64').subscribe(
  ...
  private loadNucleo_academico(){
    this.carrerasService.nucleo_academico('64').subscribe(
  ...
  private loadlineas_de_generacion(){
    this.carrerasService.linea_de_generacion('64').subscribe(
      (res: any) => { this.lineas_de_generacion = res;},
      (err) => console.error(err)
    );
  }
  private loadtutoria_seguimiento(){
    this.carrerasService.tutoria_seguimiento('64').subscribe(
  ...
  private loadalumnos_matriculados(){
    this.carrerasService.alumnos_matriculados('64').subscribe(
  ...
  private loadvinculacion_sector(){
    this.carrerasService.vinculacion_sector('64').subscribe(
  ...
  private loadproductividad_publicaciones(){
    this.carrerasService.productividad_publicaciones('64').subscribe(
  ...
  private loadproductividad_eventos(){
    this.carrerasService.productividad_eventos('64').subscribe(
  ...
  private loadproductividad_proyectos(){
    this.carrerasService.productividad_proyectos('64').subscribe(
